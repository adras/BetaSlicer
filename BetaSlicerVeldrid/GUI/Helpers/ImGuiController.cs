// This source is taken from: https://github.com/mellinoe/ImGui.NET/blob/master/src/ImGui.NET.SampleProgram/ImGuiController.cs
// 
using System;
...
namespace BetaSlicer.GUI.Helpers
{
    /// <summary>
    ...
    public class ImGuiController : IDisposable
    {
        ...
        private byte[] GetEmbeddedResourceBytes(string resourceName)
        {
            ...
            // Bugfix: Original implementation has only file names as manifest resources
            // In this project however each manifest resource contains the full pathname including the folders

            string[] resources = assembly.GetManifestResourceNames();
            string fullName = resources.FirstOrDefault(r => r.EndsWith(resourceName));

            using (Stream s = assembly.GetManifestResourceStream(fullName))
            {
